...
EXAMPLES: tuple[Example, ...] = (
    ...
    Example("colorbars.py",             28, 76, saves="png"),
    ...
    Example("jointplot.py",             35, 76, saves="png"),
    ...
    # --when is pinned with an explicit UTC offset, so that the frames and
    ...
    Example("three_body.py",            24, 80, saves="gif",
            args=("--num-frames", "6", "--no-loop")),
    Example("time_series_histogram.py", 43, 80, saves="png"),
